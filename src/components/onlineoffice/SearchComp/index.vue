<template>
  <div class="search">
    <el-form :inline="true" :model="searchForm" :rules="ruleData" ref="formRef">
      ...
      <el-form-item>
        <el-button type="primary" @click="searchHandle()" v-if="searchConfig.pageName === 'penalty'"
          >查询</el-button
        >
        <el-button type="primary" @click="addHandle()" v-if="searchConfig.pageName === 'penalty'">
          新增
        </el-button>
        <el-button type="danger" @click="deleteHandle()" v-if="searchConfig.pageName === 'penalty'">
          批量删除
        </el-button>
        <el-button
          type="warning"
